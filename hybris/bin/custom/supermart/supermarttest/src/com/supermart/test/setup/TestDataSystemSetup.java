 ...
 */
package com.supermart.test.setup;
...
import com.supermart.test.constants.SupermartTestConstants;
import com.supermart.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SupermartTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/supermarttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/supermarttest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/supermarttest/import/cstickets.impex");
			...
			importImpexFile(context, "/supermarttest/import/csquotes.impex");
		}
	}
}
