 ...
 */
package com.supermart.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(SupermartFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SupermartFulfilmentProcessConstants.PARENT_PROCESS);
