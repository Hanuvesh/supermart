 ...
 */
package com.supermart.core.constants;

/**
 * Global class for all SupermartCore constants. You can add global constants for your extension into this class.
 */
public final class SupermartCoreConstants extends GeneratedSupermartCoreConstants
{
	public static final String EXTENSIONNAME = "supermartcore";


	private SupermartCoreConstants()
	{
		//empty
	}
