...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/supermartstorefront/electronics/en",
						"https://electronics.local:9002/supermartstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/supermartstorefront/electronics/en",
						"https://electronics.local:9002/supermartstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/supermartstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/supermartstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/supermartstorefront/electronics/en",
						"https://electronics.local:9002/supermartstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/supermartstorefront",
						"https://electronics.local:9002/supermartstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/supermartstorefront",
						"https://electronics.local:9002/supermartstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/supermartstorefront/electronics/en",
						"https://electronics.local:9002/supermartstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
